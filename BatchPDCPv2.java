...
//		printLines(command + " stderr:", pro.getErrorStream());
	...
	public static void main(String[] args) {
		try {
			...
			int nAttackersPerNei = 10;//used to be 0
			...
			int numberOfAttackedNei=0;//number of Nei being attacked
			while(nHacs<=10){//10,20,30
				while(numberOfAttackedNei<=100){//0,2,4,6, 8, 10 *(5) used to be 6
					...
					//PDCP
					String filename = "WWW_E1_victim100_"+nHacs;//+"_"+nAttackersPerNei;
					process="java PDCPExp1 100 100 "+nAttackersPerNei+" "+nHacs+" "+nMCMC+" "+1+" "+filename + " "+numberOfAttackedNei;
					...
					runProcess(process);
					numberOfAttackedNei+=1;//used to be 2
					
				}
				numberOfAttackedNei=0;
