...
import java.io.*;
import java.math.*;
public class DCPCorruptedNeighborhood{
	int fast=1;
	int printLess=1;
	...
	DCPCorruptedNeighborhood(int numNei, int neiSize, BigDecimal nonAttackerPercentage, BigDecimal nonAttackerWitness,  Integer ob, int mcmcRounds, String pathOfCpt, 
...
//		CPT_observer_CS = new double[2][2];
	...
	//anchoring a neighborhood with all ineligilbe agents
	void anchoring1(){
		maxAgentId++;
	...
	public static void main(String[] args){
		...
		DCPCorruptedNeighborhood dcp = new DCPCorruptedNeighborhood(
