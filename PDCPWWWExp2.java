...
public class PDCPWWWExp2{
	...
	PDCPWWWExp2(int numNei, int neiSize, int nAttacker, int nHOA, 
...
//		CPT_observer_CS = new double[2][2];
	...
	public static void main(String[] args){
		...
		PDCPWWWExp2 dcp = new PDCPWWWExp2(
