...
//		printLines(command + " stderr:", pro.getErrorStream());
	...
	public static void main(String[] args) {
		try {
			...
			int n =100;//100000 is good, 1000 is used for experiemnts with privacy
			...
			double attackerWitnessUp=Double.parseDouble(args[0]);
			int attackerType=1;//a1n2
			int nonAttackerType=2;			
			while(attackerPercentage<1.01){//1.05
				String filename=
