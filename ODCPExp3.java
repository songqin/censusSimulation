...
public class ODCPExp3{
	...
	ODCPExp3(int numNei, int neiSize, int nAttacker, int nHOA, 
	...
	void createWitnesses(){//cw
		...
		for(int k=0;k<20;k++){//20 neighborhoods * 1 agents = 20 fixed uncensables
			...
			for(int i=0;i<1;i++){
				...
				randomCensables.add(list.get(i).id);
			}			
		}		
